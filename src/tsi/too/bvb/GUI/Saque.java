...
{//Início do corpo da classe.
 ...
 public Saque() throws Exception
 {
  ...
  botao1.setFont(new Font("Nimbus Sans L", Font.BOLD, 20));
  ...
  botaoCorrige.setFont(new Font("Nimbus Sans L", Font.BOLD, 20));
  ...
  botao0.setFont(new Font("Nimbus Sans L", Font.BOLD, 20));
  ...
  botaoSaque.setFont(new Font("Nimbus Sans L", Font.BOLD, 20));
